...
// Set create permissions for the 'users' collection for the 'BlogWriter' role
const createPermission = new CActionPermission("create");
createPermission.allowed = true;
createPermission.immutableprops = ["_id", "featured", "status", "owner", "deleted", "draft"]; // Define the properties that can't be updated by 'BlogWriter' role
createPermission.hiddenprops = ["__v", "deleted", "owner"]; // Define the properties dont't need send  to the client

// Set read permissions for the 'users' collection for the 'BlogWriter' role
const readPermission = new CActionPermission("read");
readPermission.allowed = true;
readPermission.immutableprops = ["_id", "featured", "status", "owner", "deleted", "draft"]; // Define the properties that can't be updated by 'BlogWriter' role
...
// Set update permissions for the 'users' collection for the 'BlogWriter' role
const updatePermission = new CActionPermission("update");
updatePermission.allowed = true;
updatePermission.immutableprops = ["_id", "featured", "status", "owner", "deleted", "draft"]; // Define the properties that can't be updated by 'BlogWriter' role
updatePermission.hiddenprops = ["__v", "deleted", "owner"]; // Define the properties dont't need send  to the client
...
// Set delete permissions for the 'users' collection for the 'BlogWriter' role
