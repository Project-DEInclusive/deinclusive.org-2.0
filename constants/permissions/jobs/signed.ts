...
// Set create permissions for the 'jobs' collection for the 'Signed' role
const createPermission = new CActionPermission("create");
createPermission.allowed = false;

// Set read permissions for the 'jobs' collection for the 'Signed' role
const readPermission = new CActionPermission("read");
readPermission.allowed = false;
readPermission.immutableprops = ["_id", "owner", "status", "featured", "draft", "quality", "deleted"]; // Define the properties that can't be updated by 'Signed' role
...
// Set update permissions for the 'jobs' collection for the 'Signed' role
const updatePermission = new CActionPermission("update");
updatePermission.allowed = false;

// Set delete permissions for the 'jobs' collection for the 'Signed' role
