...
createPermission.immutableprops = ["_id", "owner", "draft", "deleted"]; // Define the properties that can't be updated by 'Admin' role
...
readPermission.immutableprops = ["_id", "owner", "draft", "deleted"]; // Define the properties that can't be updated by 'Admin' role
...
updatePermission.immutableprops = ["_id", "owner", "draft", "deleted"]; // Define the properties that can't be updated by 'Admin' role
