...
// Set create permissions for the 'companies' collection for the 'Regular' role
const createPermission = new CActionPermission("create");
createPermission.allowed = false;

// Set read permissions for the 'companies' collection for the 'Regular' role
const readPermission = new CActionPermission("read");
readPermission.allowed = true;
readPermission.immutableprops = ["_id", "owner", "status", "draft", "deleted"]; // Define the properties that can't be updated by 'Regular' role
...
// Set update permissions for the 'companies' collection for the 'Regular' role
const updatePermission = new CActionPermission("update");
updatePermission.allowed = false;

// Set delete permissions for the 'companies' collection for the 'Regular' role
