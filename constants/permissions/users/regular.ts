...
// Set create permissions for the 'users' collection for the 'Regular' role
const createPermission = new CActionPermission("create");
createPermission.allowed = false;
createPermission.immutableprops = ["_id", "owner", "status", "draft", "deleted", "jobcount", "eventcount", "authid"]; // Define the properties that can't be updated by 'Regular' role
createPermission.hiddenprops = ["__v", "deleted", "authid"]; // Define the properties dont't need send  to the client

// Set read permissions for the 'users' collection for the 'Regular' role
...
// Set update permissions for the 'users' collection for the 'Regular' role
const updatePermission = new CActionPermission("update");
updatePermission.allowed = true;
updatePermission.immutableprops = ["_id", "owner", "status", "draft", "deleted", "jobcount", "eventcount", "authid"]; // Define the properties that can't be updated by 'Regular' role
...
// Set delete permissions for the 'users' collection for the 'Regular' role
