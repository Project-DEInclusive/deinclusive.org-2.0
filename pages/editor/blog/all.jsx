...
const Datatable = (props) => {
    ...
    const selectActions = [
        {
            ...
            button: () => (
                ...
                >
                    Add Blog Post <PlusIcon className="ml-2 h-5 w-5" aria-hidden="true" />
                </button>
            ),
        },
        {
    ...
    return (
        <>
            ...
            <SidePanel title={`Edit Blog Post '${editingData?._id}'`} setOpen={setEditingOpen} isOpen={editingOpen}>
                {editingData && (
                    <Add
                        data={editingData}
                        edit={true}
