    ...
    const handleImage = async (e) => {
        try {
            ...
            if (imgok) {
                ...
                handleChange({ target: { name: "thumbnail.src", value: `jobs/job-${key}.png` } });
            } else {
    ...
    const checkQuality = async () => {
        if (dataObj.content && dataObj.content.length > 70) {
            ...
            if (res && res.statusCode >= 200 && res.statusCode < 300) {
                const checkdata = JSON.parse(res.data);
                ...
                <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    ...
                    <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                        ...
                        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div className="mt-1 sm:mt-0 sm:col-span-2">
                                <div className="relative rounded-md shadow-sm block max-w-lg w-full">
                                    <div className="absolute inset-y-0 left-0 flex items-center">
                                        ...
                                        <select
                                            ...
                                            className={getInputSytle(errors.salary?.currency)}
                                    ...
                                    <input
                                        ...
                                        className={getInputSytle(errors.salary?.avarage) + " pl-20"}
                                    ...
                                    <div className="absolute inset-y-0 right-0 flex items-center">
                                        ...
                                        <select
                                            ...
                                            className={getInputSytle(errors.salary?.timeperiod)}
