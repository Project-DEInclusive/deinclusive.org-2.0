...
const Datatable = (props) => {
    ...
    const selectActions = [
        {
            ...
            button: () => (
                ...
                >
                    Add Event <PlusIcon className="ml-2 h-5 w-5" aria-hidden="true" />
                </button>
            ),
        },
        {
    ...
    return (
        <>
                                    ...
                                    data.map((item, index) => {
                                        return (
                                            <tr key={index} className="text-gray-600">
                                                ...
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                                    <div className="text-sm leading-5">{getDate(item.time.starttime)}</div>
                                                </td>
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                                    <div className="text-sm leading-5">{getDate(item.time.endtime)}</div>
                                                </td>
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
            ...
            <SidePanel title={`Edit Event '${editingData?._id}'`} setOpen={setEditingOpen} isOpen={editingOpen}>
                {editingData && (
                    <Add
                        data={editingData}
                        edit={true}
