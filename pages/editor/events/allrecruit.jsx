...
import fetcher from "../../../constants/fetch/recruit";

import useUserStore from "../../../constants/stores/userstore";

import dynamic from "next/dynamic";
const Add = dynamic(() => import("./addrecruit"));
...
const Datatable = (props) => {
    ...
    const selectActions = [
        ...
        //             }}
        //         >
        //             Add Request <PlusIcon className="ml-2 h-5 w-5" aria-hidden="true" />
        //         </button>
        //     ),
        // },
        {
    ...
    return (
        <>
                        ...
                        <div className="w-1/2 flex md:justify-end sm:justify-center text-gray-600">
                            <div className="mt-1 relative rounded-md shadow-sm w-full">
                                ...
                                >
                                    ...
                                    />
                                    <button className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-recruits-none" type="submit">
                                    ...
                                    data.map((item, index) => {
                                        return (
                                            <tr key={index} className="text-gray-600">
                                                ...
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                                    <div className="text-sm leading-5">{item.eventname}</div>
                                                </td>
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                                ...
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                                    <div className="text-sm leading-5">{item.requester.mobile}</div>
                                                </td>
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
            ...
            <SidePanel title={`Request Information`} setOpen={setEditingOpen} isOpen={editingOpen}>
                {editingData && (
                    <Add
                        readOnlyProps={[
                            "title",
