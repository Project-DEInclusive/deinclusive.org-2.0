...
const Add = dynamic(() => import("./adddemo"));
...
const Datatable = (props) => {
    ...
    const requiredProps = { requester: 1, title: 1, status: 1, createdAt: 1 };
    ...
    return (
        <>
                                            ...
                                            <tr key={index} className="text-gray-600">
                                                ...
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
                                                    <div className="text-sm leading-5">
                                                        {getBooleanStatus(item.requester && item.requester.id && item.requester.id.length > 2 ? true : false)}
                                                    </div>
                                                </td>
                                                <td className="px-6 py-2 whitespace-no-wrap border-b border-gray-200">
            ...
            <SidePanel title={`Edit Request '${editingData?._id}'`} setOpen={setEditingOpen} isOpen={editingOpen}>
                {editingData && (
                    <Add
                        data={editingData}
                        edit={true}
