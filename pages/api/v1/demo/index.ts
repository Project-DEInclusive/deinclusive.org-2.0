...
import Schema from "../../../../types/schema/demo/SDemo";
...
async function handleGET(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        let count = 0;
        let resp = {};
        var p = permissions.getUserCollectionPermission(userType, "demo"); // Get the permissions for the current obj
...
async function handlePOST(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        obj.requester.id = userId; // Set the owner of the obj
